...
public class Period {
    ...
    public static Period of(LocalDate startDate, LocalDate endDate){
        ...
        return new Period(startDate.atStartOfDay(), LocalDateTime.of(endDate, LocalTime.of(23,59,59,9999999)));
    }
    ...
    public boolean isOverlapped(LocalDate date) {
        return isOverlapped(date.atStartOfDay(), LocalDateTime.of(date, LocalTime.of(23,59,59,9999999)));
    }
